...
export default function OrderLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/order/auth/login', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-xl font-bold text-center mb-2 text-white">Order Management</h1>
        <p className="text-sm text-gray-400 text-center mb-6">Login untuk mengelola order</p>
